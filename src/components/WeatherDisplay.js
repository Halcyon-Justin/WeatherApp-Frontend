...
const WeatherDisplay = ({ weatherData }) => {
  ...
  const sortedHighLows = weatherData?.data?.highLows?.sort((a, b) => new Date(a.day) - new Date(b.day)) || [];
        ...
        <div>
          ...
          <div className="flex flex-wrap justify-center">
            {sortedHighLows.map((dayData, index) => {
              ...
              return (
                <div key={dayData.day} className="flex-shrink-0 w-48 p-4 border rounded-md m-4">
